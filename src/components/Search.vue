        ...
        <div class="weather-warp" v-show="isMenus">
          <div class="weather-menus">
            ...
            <div class="weather-menu gxs-cell gxs-cells-icon">
              <div class="weather-bd gxs-cell-bd gxs-cell-default"><a href="http://yangapp.xyz">我的主页</a></div>
            </div>
            <div class="weather-menu gxs-cell gxs-cells-icon">
              <div class="weather-bd gxs-cell-bd gxs-cell-default">联系方式： didiaochenmonan@163.com</div>
              <!-- <div class="weather-ft gxs-cell-ft"></div> -->
            </div>
            <div class="weather-ft gxs-cell-ft">最后更新：2017.06.01</div>
          </div>
